	...
	*/
	...
	class Validator extends CPFCNPJ {
		...
		public $errors_msg=array(
			...
			102=>'O campo <strong>%%campo%%</strong> não é uma matricula valida.',
			...
			106=>'As senhas não coincidem.',
			107=>'O campo <strong>%%campo%%</strong> não é uma matricula valida ou já esta cadastrada.'
		);
		...
		public function field_cadastrado($field){
		...
		public function field_senhas($field,$field2){
			if(!($this->request[$field] == $this->request[$field2])){
